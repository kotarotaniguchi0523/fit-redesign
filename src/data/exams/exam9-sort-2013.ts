...
export const exam9_2013: Question[] = [
	...
	},
	{
		id: "exam9-2013-q2",
		number: 2,
		text: "アルゴリズムA「基準値についてデータ列を二つの組に分割し、それを再帰的に繰り返す」、アルゴリズムB「整列済みの列の正しい位置にデータを挿入していく」の名称として適切な組を選べ",
		options: [
			{ label: "ア", value: "A. クイックソート, B. 基本挿入法", isCorrect: true },
			{ label: "イ", value: "A. マージソート, B. 基本挿入法" },
			{ label: "ウ", value: "A. ヒープソート, B. バブルソート" },
	...
	},
	{
		id: "exam9-2013-q4",
		number: 4,
		text: "次のオーダーを小さい順に並び替えよ。\nn², 2ⁿ, n log n, n!",
		answer: "n log n, n², 2ⁿ, n!",
		explanation: "計算量の大小: O(n log n) < O(n²) < O(2ⁿ) < O(n!)",
	},
	{
		id: "exam9-2013-q5",
		number: 5,
