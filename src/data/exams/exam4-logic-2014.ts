...
export const exam4_2014: Question[] = [
	...
	},
	{
		...
		answer: "F: 0,1,1,0",
		explanation:
			"回路の構成: 上段はX,YのNANDゲート、下段はNOT(X)とYのNANDゲート、それらの出力をNORゲートに入力。結果はXOR（排他的論理和）と同等: F = X⊕Y",
		figureData: {
			type: "logicCircuit",
			inputs: [
			...
			gates: [
				{ id: "NAND1", type: "NAND", x: 180, y: 70 },
				{ id: "NOT1", type: "NOT", x: 120, y: 120 },
				{ id: "NAND2", type: "NAND", x: 180, y: 130 },
				{ id: "NOR1", type: "NOR", x: 280, y: 100 },
			],
