...
// // 2014年度
import { exam1_2014 } from "./exam1-base-2014";
// 2015年度
import { exam1_2015 } from "./exam1-base-2015";
// 2016年度
import { exam1_2016 } from "./exam1-base-2016";
// 2017年度
...
import { exam5_2015 } from "./exam5-ecc-2015";
...
import { exam9_2014 } from "./exam9-sort-2014";

const getAvailableYears = (exams: ExamByYear["exams"]): Year[] =>
	YEARS.filter((year): year is Year => Boolean(exams[year]));
...
function createExamByYear(
	...
	return {
		examNumber,
		title,
		availableYears: getAvailableYears(exams),
		exams,
	};
}
...
const exam1Exams: ExamByYear["exams"] = {
	...
	"2017": {
		...
		number: 1,
		title: "基数変換 (2017)",
		pdfPath: "/pdf/Exam1e-Base.pdf",
		answerPdfPath: "/pdf/Exam2017-Ans.html",
		questions: exam1_2017,
	},
};

export const exam1 = createExamByYear(1, "基数変換", exam1Exams);
...
export const exam2 = createExamByYear(2, "負数表現 / 浮動小数点・論理演算", exam2Exams);
...
export const exam4 = createExamByYear(4, "論理演算 / オートマトン・符号理論", exam4Exams);
...
export const exam5 = createExamByYear(5, "集合 / データ構造・ソート", exam5Exams);
...
export const exam6 = createExamByYear(6, "確率 / FSM・確率・データ構造", exam6Exams);
...
export const exam7 = createExamByYear(7, "オートマトン / 符号理論", exam7Exams);
...
export const exam8 = createExamByYear(8, "符号理論 / データ構造", exam8Exams);
...
export const exam9 = createExamByYear(9, "データ構造 / ソート・探索", exam9Exams);
