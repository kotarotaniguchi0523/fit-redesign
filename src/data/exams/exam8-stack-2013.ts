...
export const exam8_2013: Question[] = [
	...
	},
	{
		id: "exam8-2013-q2",
		number: 2,
		text: "単方向リスト構造に対する次の操作の内、ポインタを参照する回数が最も多いものはどれか？ただし、先頭ポインタとは別に、末尾のデータを指す末尾ポインタがある",
		options: [
			{ label: "ア", value: "先頭にデータを挿入" },
			{ label: "イ", value: "先頭のデータを削除" },
			{ label: "ウ", value: "末尾にデータを挿入" },
			{ label: "エ", value: "末尾のデータを削除", isCorrect: true },
		],
		answer: "エ",
		explanation: "末尾削除は、末尾の一つ前のノードを見つけるためにリストを先頭から辿る必要がある",
	},
	{
		id: "exam8-2013-q3",
		number: 3,
	...
	},
	{
		id: "exam8-2013-q4",
		number: 4,
		text: "節点数63の完全二分木がある。検索する時に比較する節点の数は最大いくらか？",
		answer: "6",
		explanation: "完全二分木の高さ: 2^h - 1 = 63 → h = 6。最大比較回数は高さに等しい6回",
	},
	{
		id: "exam8-2013-q5",
		number: 5,
