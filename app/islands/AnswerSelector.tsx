...
import { recordAnswer, SavingIndicator } from "../../src/features/answer/answerActions";
import { fetchAnswerStatuses } from "../../src/features/answer/answerClient";
import {
	clearStatusChip,
	hideSolution,
	revealSolution,
	setStatusChip,
} from "../../src/features/answer/questionCardUi";
...
function AnswerSelectorPanel(props: {
	...
	return (
		<>
			...
			{submitted ? (
				<div class={`q-feedback ${state.isCorrect ? "is-correct" : "is-review"}`} aria-live="polite">
					{state.isCorrect
						? "正解！ この調子でいこう。"
